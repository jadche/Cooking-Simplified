...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFAF9FC);
  late Color secondary = const Color(0xFFFF9766);
  late Color tertiary = const Color(0xFFFF6162);
  late Color alternate = const Color(0xFFFFAAA2);
  late Color primaryText = const Color(0xFF16161A);
  late Color secondaryText = const Color(0xFF747D88);
  late Color primaryBackground = const Color(0xFFFAF9FC);
  late Color secondaryBackground = const Color(0xFFFAF9FC);
  late Color accent1 = const Color(0xFFFF8F45);
