...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => DetailPageWidget(
            recipeID: params.getParam(
                'recipeID', ParamType.DocumentReference, false, ['recipes']),
          ),
        ),
        FFRoute(
          name: 'cookPage',
          path: '/cookPage',
          builder: (context, params) => CookPageWidget(
            steprecipeID: params.getParam('steprecipeID',
                ParamType.DocumentReference, false, ['recipes']),
            stepCount: params.getParam('stepCount', ParamType.int),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'donePage',
          path: '/donePage',
          builder: (context, params) => DonePageWidget(),
        ),
        FFRoute(
          name: 'homePage',
          path: '/homePage',
        ...
        FFRoute(
          ...
          builder: (context, params) => IngredientsPageWidget(),
        ),
        FFRoute(
          name: 'addRecipePage',
          path: '/addRecipePage',
        ...
        FFRoute(
          name: 'likesPage',
          path: '/likesPage',
          builder: (context, params) => LikesPageWidget(),
        ),
        FFRoute(
          name: 'editRecipePage',
          path: '/editRecipePage',
        ...
        FFRoute(
          name: 'addEditPage',
          path: '/addEditPage',
          builder: (context, params) => AddEditPageWidget(),
        )
